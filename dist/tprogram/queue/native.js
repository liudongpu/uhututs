...
var QueueNative = /** @class */ (function () {
    ...
    QueueNative.update = function (oConfig) {
        ...
        if (!index_1.TNodeIoFile.flagExist(sNativePath)) {
            index_1.TNodeProtoProcess.spawnSync("react-native", ["init",
    ...
    QueueNative.processScript = function (oConfig) {
        ...
        index_2.TBase.logDebug(3411005);
        index_1.TNodeIoFile.copyDir(index_1.TNodeIoPath.upBinPath() + "/lib/wnative", launch_1.EasyLaunch.upGoNativePath("scripts/adapter/wnative"));
        index_1.TNodeIoFile.copyDir(index_1.TNodeIoPath.upBinPath() + "/lib/tcore", launch_1.EasyLaunch.upGoNativePath("scripts/adapter/tcore"));
    };
    return QueueNative;
}());
