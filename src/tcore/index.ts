import { HelperDate as TCoreHelperDate } from './helper/date';
...
import {HelperUrl as TCoreHelperUrl} from './helper/url';

export {TCoreCommonFunc,TCoreHelperMap,TCoreHelperObject,TCoreHelperString,TCoreHelperUrl,TCoreHelperDate};