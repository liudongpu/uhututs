export class HelperString {
    ...
    static split(source : string) {
        return source.split(',');
    }

    static containsOfArrayString(source : string, searchofArray : string) : boolean {
        let bReturn = false;
     ...
     */
    static reaplaceBig(sInString : string, sStart : string, sEnd : string, sWith : string, sAfter : string) {
     ...
     * @memberOf Mexport
     */
    static replaceAll(sInString, sReplace, sWith) : string {
